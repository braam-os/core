...
export function check() {
    ...
    // Three copies of an 8,628-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 28,080 bytes is fifty chunks against eight
    ...
    // them.
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "516 4500 28080");
