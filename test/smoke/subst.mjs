...
export function check() {
    ...
    // Three copies of a 7,453-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 22,359 bytes is forty chunks against eight
    ...
    // them.
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "450 3480 22359");
